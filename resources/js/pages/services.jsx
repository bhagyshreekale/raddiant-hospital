...
export default function ServicesPage() {
  ...
  // THE UPDATED COLOR TEXTURE: Dark-to-Light Blue & Dark-to-Light Green
  const radialBgStyle = {
    backgroundColor: '#010b14', // Very Dark Blue Base
    background: `
        ...
        >
          <motion.div variants={textReveal} className="flex justify-center">
            <div className="relative group overflow-hidden rounded-full p-[1px]">
              {/* Border spin using Dark-to-Light Blue/Green colors */}
          ...
          <motion.h1 variants={textReveal} className="mt-6 text-4xl font-extrabold text-white md:text-5xl tracking-tight">
            Our Medical Services
          </motion.h1>

          <motion.p variants={textReveal} className="mx-auto mt-6 max-w-xl text-lg text-slate-300 font-medium leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {SERVICES.map((s) => (
              <div key={s.id}><ServiceCard service={s} /></div>
            ))}
          </div>
