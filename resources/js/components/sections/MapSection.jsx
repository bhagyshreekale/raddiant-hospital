...
export default function MapSection() {
    const items = [
        ...
        { icon: <FaEnvelope />, label: 'Email', value: SITE.email },
        {
            icon: <FaClock />,
            label: 'OPD Hours',
            value: 'Mon–Sat: 9:00 AM – 8:00 PM | Emergency: 24/7',
        },
    ];
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col items-center gap-12 lg:flex-row">
                    ...
                    <div className="w-full lg:w-5/12">
                        <span className="inline-block rounded-full bg-[var(--primary)]/10 px-4 py-1 text-xs font-bold tracking-widest text-[var(--primary)] uppercase">
                            Find Us
                        </span>
                        ...
                        <div className="flex flex-col gap-6">
                            {items.map((item) => (
                                ...
                                >
                                    {/* Icon Square */}
                                    <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[var(--primary)] text-blue-900 shadow-[var(--primary)]/20 shadow-md transition-transform group-hover:scale-110">
                                        {item.icon}
                                    </div>

                                    {/* Label + Value */}
                                    <div>
                                        <div className="text-[0.7rem] font-bold tracking-wider text-gray-500 uppercase">
                                            {item.label}
                                        </div>
